...
An interesting consequence of considering that the wavefunction, $\Psi$, as a density $R$ and a phase $\theta$ is the fact that to remain single-valued, the change of phase around any {\it closed} curve $C$ must be an integer of $2\pi$,
\begin{equation}
