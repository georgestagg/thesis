...
\begin{center}
  ...
  \begin{axis}[ylabel near ticks,xlabel near ticks,
      ...
      \node[anchor=west] at (axis cs:  1.25,  77) {Drift};
      \node[anchor=west] at (axis cs:  1.25,  55) {Annihilation};
    \end{axis}
\end{tikzpicture}
\begin{tikzpicture}
  \begin{axis}[ylabel near ticks,xlabel near ticks,
      ...
      \node[anchor=west] at (axis cs:  2,  58) {Drift};
      \node[anchor=west] at (axis cs:  2,  40) {Annihilation};
    \end{axis}
\end{tikzpicture}\\%
\begin{tikzpicture}
  \begin{axis}[ylabel near ticks,xlabel near ticks,
