...
{\rm St}_s = \frac{fD}{v},
\end{equation}
where $f$ is defined as the dominant mode in the frequency power spectrum of the transverse force on the obstacle, $F_y$, defined in Appendix \ref{appsection:force}.
