...
\hline
\end{tabular}
\caption{Measurements of quantities related to the calculation of the superfluid Reynolds number, ${\rm Re}_s$ \cite{reeves_2015}, from a selection of our simulations with $\varepsilon=1$ and $d=5\xi$. A predicted Strouhal number is also listed, based on the best fit ${\rm St}-{\rm Re}_s$ curve calculated in \cite{reeves_2015}. Our measurements of ${\rm St}$ agree well with the findings of Reeves \emph{et. al.}}
\label{tbl:re_st}
\end{table}
