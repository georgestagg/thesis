...
%a5
%\usepackage[c5paper,twoside,left=25mm,right=18mm,top=28mm,bottom=25mm]{geometry}
%------------------------------------------------------------------------------
...
\begin{document}
  ...
  \phdtitle{A Numerical Study of Vortices and Turbulence in Ultra-cold Bose Gases and Superfluid Helium} % Title.
  ...
  \newpage
  \thispagestyle{empty}
  \noindent The work featured in this thesis was carried out over the period of $2012$--$2016$. Some of the results over that time have also been previously published in the following works:
  \begin{itemize}
  ...
  \end{itemize}
  Relevant research that can also be found in these publications has been extended and all copyrighted material belonging to external publishers has been removed before inclusion in this thesis.
  \vspace*{\fill}
  ...
  \include{./vortexdeflection/chapter}
  \include{./wake/chapter}
  \include{./shin/chapter}
