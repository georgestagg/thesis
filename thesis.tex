...
\begin{document}
  ...
  \part{Quantum Analogs of Classical Wakes}
  \include{./wake/chapter}                     % A chapter.

  \part{Generation and Decay of Two Dimensional Quantum Turbulence}
  \include{./shin/chapter} % Another chapter.
  
  \part{Superfluid Flow Around Rough Obstacles and Boundaries}
