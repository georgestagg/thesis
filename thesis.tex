...
%a5
%\usepackage[b5paper,twoside,left=25mm,right=18mm,top=28mm,bottom=25mm]{geometry}
%------------------------------------------------------------------------------
...
\begin{document}
  ...
  %\vspace*{\fill} 
  %\begin{quote}  
 % {\it "There was one picture in particular which bothered him. It had begun with a leaf caught in the wind, and it became a tree; and the tree grew, sending out innumerable branches, and thrusting out the most fantastic roots."}
 % \end{quote}
  %\hspace{3in}Leaf by Niggle - J.R.R. Tolkien
  %\vspace{5in}
  %\vspace*{\fill}
